...
export default async function LocaleLayout({ children, params }: Props) {
    ...
    return (
        ...
        <body
            className={`${notoSerif.variable} ${shipporiMincho.variable} ${nunito.variable} font-noto-serif bg-(--main-colour) dark:bg-(--main-colour-dark) text-(--text-colour) dark:text-(--text-colour-dark)`}>
